-- QasyrStore Hub – Fish It Full Final
-- Local Only
...
-- Delay input (custom)
local ReelDelayInput = Instance.new("TextBox", Main)
ReelDelayInput.Size = UDim2.new(0.4,0,0,25)
ReelDelayInput.Position = UDim2.new(0.05,0,0.26,0)
ReelDelayInput.PlaceholderText = "Delay Reel (s)"
ReelDelayInput.Text = tostring(State.DelayReel)
ReelDelayInput.ClearTextOnFocus = false
ReelDelayInput.TextColor3 = Color3.fromRGB(255,255,255)
ReelDelayInput.BackgroundColor3 = Color3.fromRGB(35,35,35)

ReelDelayInput.FocusLost:Connect(function()
    local val = tonumber(ReelDelayInput.Text)
    if val then State.DelayReel = val end
end)

local FishingDelayInput = Instance.new("TextBox", Main)
FishingDelayInput.Size = UDim2.new(0.4,0,0,25)
FishingDelayInput.Position = UDim2.new(0.55,0,0.26,0)
FishingDelayInput.PlaceholderText = "Delay Fishing (s)"
FishingDelayInput.Text = tostring(State.DelayFishing)
FishingDelayInput.ClearTextOnFocus = false
FishingDelayInput.TextColor3 = Color3.fromRGB(255,255,255)
FishingDelayInput.BackgroundColor3 = Color3.fromRGB(35,35,35)

FishingDelayInput.FocusLost:Connect(function()
    local val = tonumber(FishingDelayInput.Text)
    if val then State.DelayFishing = val end
end)

local AutoSellBtn = createButton("Auto Sell: OFF", 0.33, Main)
